...
class AppStateNotifier extends ChangeNotifier {
  ...
  CheapitAppAuthUser? initialUser;
  CheapitAppAuthUser? user;
  ...
  void update(CheapitAppAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/favourite',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'favourite')
              : FavouriteWidget(),
        ),
        FFRoute(
          name: 'Account',
        ...
        FFRoute(
          name: 'orderaccepted2',
          path: '/orderaccepted2',
          builder: (context, params) => Orderaccepted2Widget(),
        )
